...
DELETE FROM Offices1;
DELETE FROM OrderDetails1;
DELETE FROM Orders1;
DELETE FROM Payments1;
DELETE FROM Products1;

LOAD DATA LOCAL INFILE 'Customers1.txt' INTO TABLE Customers1 
FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\n';
-- SHOW WARNINGS LIMIT 10;

LOAD DATA LOCAL INFILE 'Employees1.txt' INTO TABLE Employees1
FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\n';
-- SHOW WARNINGS LIMIT 10;

LOAD DATA LOCAL INFILE 'Offices1.txt' INTO TABLE Offices1
FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\n';

LOAD DATA LOCAL INFILE 'Products1.txt' INTO TABLE Products1
FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\n';
-- SHOW WARNINGS LIMIT 10;

LOAD DATA LOCAL INFILE 'OrderDetails1.txt' INTO TABLE OrderDetails1
FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\n';
-- SHOW WARNINGS LIMIT 10;

LOAD DATA LOCAL INFILE 'Orders1.txt' INTO TABLE Orders1
FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\n';
-- SHOW WARNINGS LIMIT 10;

LOAD DATA LOCAL INFILE 'Payments1.txt' INTO TABLE Payments1
FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\n';
-- SHOW WARNINGS LIMIT 10;
